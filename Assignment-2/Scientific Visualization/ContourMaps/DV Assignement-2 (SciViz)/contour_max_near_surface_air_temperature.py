...
plot_dir = 'max_near_surface_air_temperature_plots_cartopy_contour'
...
for day in range(0, len(days), 10):
    ...
    temperature_range_day = tmmx['air_temperature'].sel(day=days[day])
    ...
    # Create contour plot
    contour = ax.contour(lon, lat, temperature_range_day, 
    ...
    # Save the plot
    plot_path = os.path.join(plot_dir, f"max_near_surface_air_temperature_contour_{date}.png")
...
image_dir = 'max_near_surface_air_temperature_plots_cartopy_contour'
...
# Create a GIF
with imageio.get_writer('max_near_surface_air_temperature_animation_contour.gif', mode='I', duration=n_frames*100) as writer:
