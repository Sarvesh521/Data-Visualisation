...
SKIP= 1
SCALE_UNITS = 'height'
OUTPUT_PATH = "../outputs/initial.gif"
...
def update_quiver(day_idx):
    ...
    # Convert wind direction and speed to U, V components for the current day, with downsampling
    u, v = wind_components(wind_speed[selected_indices[day_idx]][::SKIP, ::SKIP], wind_direction[selected_indices[day_idx]][::SKIP, ::SKIP])
...
qv = ax.quiver(lon_grid, lat_grid, u, v, scale=140,scale_units=SCALE_UNITS, transform=ccrs.PlateCarree()) 
